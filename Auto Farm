local gui = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/z4gs/scripts/master/testtttt.lua"))():AddWindow("MAYURI HUB", {
    main_color = Color3.fromRGB(102,0,51),
    min_size = Vector2.new(340, 340),
    can_resize = true
})
...
local tab1, tab2, tab3, tab4, tab5 = gui:AddTab("Main"), gui:AddTab("Farm Options"), gui:AddTab("Trainer"), gui:AddTab("Misc"), gui:AddTab("Bosses")
